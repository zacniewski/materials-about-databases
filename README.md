...
Repozytorium zawiera materiały dla przedmiotu "Bazy danych", obejmujące 15 godzin ćwiczeń laboratoryjnych oraz 15 godzin pracy projektowej.

## Spis treści

### [Laboratoria (15h)](./labs/)
1. [Laboratorium 1: Podstawy SQL - DDL i DML (część 1)](./labs/lab01_sql_basics_1.md) - 2h
2. [Laboratorium 2: SQL - Zapytania, złączenia i agregacja (część 2)](./labs/lab02_sql_basics_2.md) - 2h
3. [Laboratorium 3: Zaawansowany SQL - Podzapytania i widoki](./labs/lab03_sql_advanced.md) - 2h
