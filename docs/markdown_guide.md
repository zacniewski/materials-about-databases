...
1. Wyeksportuj dokument najpierw do formatu **HTML**, otwórz go w przeglądarce i wydrukuj do PDF lub skorzystaj z profesjonalnych generatorów online.
...
1. Upewnij się, że masz włączony podgląd Markdown (ikona dzielonego okna w prawym górnym rogu edytora).
1. Kliknij prawym przyciskiem myszy w obszarze edytora tekstu lub podglądu.
1. Wybierz opcję **Export to PDF...** (lub **Export to HTML...** jeśli wolisz format przeglądarkowy).
1. Wybierz miejsce zapisu i potwierdź.
...
1. Otwórz plik `.md`.
1. Kliknij prawym przyciskiem myszy wewnątrz edytora tekstu.
1. Wybierz opcję **Markdown PDF: Export (pdf)**.
1. Plik PDF zostanie wygenerowany w tym samym folderze co plik źródłowy.
